...
elgar_I_clarinet_I = {
  ...
  \relative c' {
    ...
    e4.~(\f e4 d8) c4.~(\> c4 a8) |
    R1*12/8 |
    b8(\p\<\rit b,8. d16 a8\> des e\! f4) r8 r4. |
    \time 6/8
    R1*6/8 |
    \bar "||"
    \rMark
  ...
  \relative c' {
    ...
    <<
      ...
      \new CueVoice {
        \voiceTwo
        \stemDown
        d'16-.\solo d-. d-. d-. d( f) f f f( d) d d d( cis) cis cis\fermata |
      }
    >>
    \bar "||"
    \textEndMark \markup { \musicglyph "scripts.ufermata" }
  ...
  \relative c' {
    ...
    <<
      ...
      \new CueVoice {
        \voiceOne
        \stemDown
        c,32( es c es) fis( a fis a) c( es c es) dis( \once \omit Accidental fis dis fis) a4~ \once \hideNotes a4 |
      }
    >>
    \bar "||"
    \mBreak
    ...
    \rMark
    r4 h^^(\f |
    a8) gis16-. a-. <e \tweak font-size #-2 e'>8\< ges16-. g-.\! |
    as8-. r h4^^(\p |
    a8) gis16-. a-. <e \tweak font-size #-2 e'>8-. \tuplet 3/2 { ges16( as a } |
    b8) r des4^^(\f |
    ...
    \rMark
    R2*5\tempoPrimo |
    g,,,8(\f f16 g <e \tweak font-size #-2 e'>8 f16 g) |
    a8( h16 cis d8 cis16 d) |
    \tuplet 3/2 {e8.( des16 a8) } \tuplet 3/2 {g8( a <e \tweak font-size #-2 e'!>) } |
    \rMark
    R2*4 |
    r8 c''4->(\f a8) |
    \mBreak
    ...
    % cl1 p6 5
    R2 |
    <e, \tweak font-size #-2 e'>8(\f ges16 as a8 gis16 a) |
    h8( a16 h as8 a16 h) |
    c8 h16 c h8 a16 h |
    ...
    % cl1 p6 7
    % ff from cl2
    ges,16(\ff as b h des d e f |
    ges16 g as b h8) r |
    a8 g16 a ges8 f16 ges |
    d8 r g4-^ |
    ges8 e16 ges d8 cis16 d |
    h8 r e' r |
    \mBreak
    ...
    % cl1 p7 3
    \acciaccatura { f16 g } f8-! e16-. f-. c8-. d16-. es-. |
    \bar "||"
    \time 4/4
    \rMark
    \tempo "Poco più lento"
  ...
  \relative c' {
    ...
    <<
      ...
      \new CueVoice {
        ...
        s1
        \repeat tremolo 4 d16-.\solo d( f) f f f( d) d d d( c) c c |
      }
    >>
    \mBreak
    ...
    <<
      {
        ...
        R1 |
        \voiceTwo
        r2 \voiceOne \stemDown r4 g''16(\ff as b? h |
        c8) r r4 r2 |
        \revert MultiMeasureRest.staff-position
      }
      \\
    ...
    ges8-. r r4 r2 |
    R1 |
    <e \tweak font-size #-2 e'>8-. r r4 r2 |
    R1 |
    b'1(\ppp |
    \rMark
    a4) r r2 |
    ...
    <<
      {
        \override MultiMeasureRest.staff-position = #-6
        % Cl1 has "colla parte" instead
        R1*2\pocoSostenuto |
        \revert MultiMeasureRest.staff-position
      }
      \\
      \new CueVoice {
        \acciaccatura c8 c'8\solo c4 c'8~ c c4 g'8~ |
        g8 g4 g8~( g8 g,) g-- g-- |
     }
    >>
    \rMark
...
elgar_IV_clarinet_II = {
  ...
  \relative c' {
    ...
    r8 e'4->(\f c8) |
    R2 |
    <e, \tweak font-size #-2 e'>8(\f ges16 gis a8 gis?16 a) |
    h8( a16 h gis8 a16 h) |
    c8 h16 c h8 a16 h |
    \mBreak
    
    % cl2 p6 7
    c8 h16 c des8 c16 des |
    d8 es?16 f g8 as16 b |
